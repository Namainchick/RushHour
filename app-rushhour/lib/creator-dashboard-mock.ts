...
export const CREATOR_REQUESTS: CreatorRequest[] = [
  { id: "rq_trattoria", business: "Trattoria Bella", category: "Italian Restaurant", city: "Hamburg-Eppendorf", initial: "T", tint: "bg-rose-100 text-rose-700", deliverable: "1 Reel + 2 Stories", budget: 350, matchScore: 92, status: "neu" },
  ...
  { id: "rq_sull", business: "Weinbar Süll", category: "Wine Bar", city: "Hamburg-Eimsbüttel", initial: "S", tint: "bg-purple-100 text-purple-700", deliverable: "1 Reel", budget: 300, matchScore: 79, status: "angenommen", day: 9 },
  ...
  { id: "rq_pastabar", business: "Pasta & Co", category: "Italian", city: "Hamburg-Altona", initial: "P", tint: "bg-sky-100 text-sky-700", deliverable: "1 Reel", budget: 320, matchScore: 88, status: "abgeschlossen", day: 2 },
];
